...
class _GiveKudosScreenState extends State<GiveKudosScreen> {
          ...
          children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Show appreciation for a team member',
            ...
            TextFormField(
              ...
              decoration: const InputDecoration(
                hintText: 'What do you appreciate about them?',
            ...
            SwitchListTile(
              ...
              subtitle:
                  const Text('Make this kudos visible to all team members'),
              secondary: Icon(
            ...
            FilledButton.icon(
              ...
              label: Text(interactions.isSaving ? 'Sending...' : 'Send Kudos'),
  ...
  Future<void> _submit(BuildContext context, String? fromEmail) async {
    ...
    final success = await interactions.giveKudos(
      from: fromEmail,
